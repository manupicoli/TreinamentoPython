...
class Seres_Vivos:
    ...
    def causar_dano(self, alvo): #o alvo vai ser o objeto que está sendo atacado
        pontos_ganhos = self.ponto_de_ataque #os pontos ganhos com o ataque vão diminuir os pontos de vida do atacado
...
class Lobo(Monstro):
    def __init__(self, ponto_de_vida, ponto_de_ataque, tipo, forca):
